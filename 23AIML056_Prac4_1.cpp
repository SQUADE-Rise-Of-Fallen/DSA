/*Implement below operations of doubly linked lists.
(a) Insert a node at front
(b) Insert a node at back
(c) Insert a node before a node
(d) Insert a node after a node
(e) Delete a node at front
(f) Delete a Node at back
(g) Delete a Specific Node
(h) Delete all nodes of linked list
Display Linked List After Every Operation*/
#include <iostream>
using namespace std;
